...
{   
    [CustomPropertyDrawer(typeof(ISerializableQueue), true)]
    public class UnityQueuePropertyDrawer : PropertyDrawer 
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            list = DrawQueue(position, property, label, valuesProperty);
            if(list is null)
            {
                ...
                if(property.isExpanded)
                    EditorGUI.LabelField(new Rect(position.x, position.y + lineHeight + verticalSpacing, position.width, lineHeight), "Queue is Empty");
            }
            else
            {
        ...
        static ReorderableList DrawQueue(Rect position, SerializedProperty property, GUIContent label, SerializedProperty valuesProperty)
        {
            if (property == null) 
                return null;
            ...
            list.drawNoneElementCallback += rect =>  EditorGUI.LabelField(rect, "Queue is Empty");
